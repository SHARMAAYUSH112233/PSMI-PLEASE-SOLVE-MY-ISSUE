class Game {
  ...
  start() {
    ...
    steeringWheel = createSprite(width / 2 - 300, height - 150);
    steeringWheel.addImage("steeringWheel", steeringWheelImg);
    steeringWheel.scale = 0.4;

    nos = createSprite(width / 2 + 400, height - 75);
    nos.addImage("nos", nosImg);
    nos.scale = 0.5;
